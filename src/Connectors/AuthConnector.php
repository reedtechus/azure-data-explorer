...
namespace ReedTech\AzureAppAuth\Connectors;

use ReedTech\AzureAppAuth\Requests\Auth\FetchTokenRequest;
...
class AuthConnector extends SaloonConnector
{
    ...
    public function __construct(protected string $apiBaseUrl = 'https://login.microsoftonline.com')
    {
    }
